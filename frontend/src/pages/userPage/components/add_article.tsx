...
import { createUserArticle } from '@api/articles/createUserArticle';
import {editArticle} from '@api/articles/editArticle'

interface AddArticleProps {
  editArticleId: string | null;
  setEditArticleId: (id: string | null) => void;
  setActiveTab: React.Dispatch<React.SetStateAction<'account-info' | 'reviews' | 'wanted' | 'played' | 'articles' | 'add_article'>>
}
